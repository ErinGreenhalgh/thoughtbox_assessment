  ...
  if (link.status === "false") {
    return "<div class='link-full " + link.status +"' id=" + link.id
              ...
              + "<div class='link-status' data-status=" +link.status+ " data-id=" + link.id + ">"
                ...
                + "<button style='display:none' class='mark-unread btn btn-default' data-id=" + link.id + ">Mark as Unread</button>"
              + "</div>"
            + "</div>" + "<br>"
  } else {
    return "<div class='link-full " + link.status +"' id=" + link.id
              + "><div class='link-info'>"
                ...
                + "</div>"
              + "<div class='link-status' data-status=" +link.status+ " data-id=" + link.id + ">"
                + "<button style='display:none' class='mark-read   btn btn-default' data-id=" + link.id + ">Mark as Read</button>"
